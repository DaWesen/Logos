...
var RegisterReq_Phone_DEFAULT string

func (p *RegisterReq) GetPhone() (v string) {
	if !p.IsSetPhone() {
		return RegisterReq_Phone_DEFAULT
	}
	return *p.Phone
}
...
func (p *RegisterReq) IsSetPhone() bool {
	return p.Phone != nil
}
...
func (p *LoginRegisterResp) GetExpireAt() (v int64) {
	return p.ExpireAt
}
...
func (p *LoginRegisterResp) SetExpireAt(val int64) {
	p.ExpireAt = val
}
...
type UpdateUserReq struct {
	...
	Preferences  map[string]string `thrift:"preferences,5,optional" frugal:"5,optional,map<string:string>" json:"preferences,omitempty"`
	Interests    []string          `thrift:"interests,6,optional" frugal:"6,optional,list<string>" json:"interests,omitempty"`
	OldPassword  *string           `thrift:"oldPassword,7,optional" frugal:"7,optional,string" json:"oldPassword,omitempty"`
	NewPassword_ *string           `thrift:"newPassword,8,optional" frugal:"8,optional,string" json:"newPassword,omitempty"`
}
...
var UpdateUserReq_Preferences_DEFAULT map[string]string

func (p *UpdateUserReq) GetPreferences() (v map[string]string) {
	if !p.IsSetPreferences() {
		return UpdateUserReq_Preferences_DEFAULT
	}
	return p.Preferences
}

var UpdateUserReq_Interests_DEFAULT []string

func (p *UpdateUserReq) GetInterests() (v []string) {
	if !p.IsSetInterests() {
		return UpdateUserReq_Interests_DEFAULT
	}
	return p.Interests
}
...
func (p *UpdateUserReq) SetPhone(val *string) {
	p.Phone = val
}
func (p *UpdateUserReq) SetAvatar(val *string) {
	p.Avatar = val
}
func (p *UpdateUserReq) SetPreferences(val map[string]string) {
	p.Preferences = val
}
func (p *UpdateUserReq) SetInterests(val []string) {
	p.Interests = val
}
...
func (p *UpdateUserReq) IsSetPreferences() bool {
	return p.Preferences != nil
}

func (p *UpdateUserReq) IsSetInterests() bool {
...
type UserStats struct {
	UserId              int64 `thrift:"userId,1" frugal:"1,default,i64" json:"userId"`
	QuestionCount       int64 `thrift:"questionCount,2" frugal:"2,default,i64" json:"questionCount"`
	AnswerCount         int64 `thrift:"answerCount,3" frugal:"3,default,i64" json:"answerCount"`
	RecommendationCount int64 `thrift:"recommendationCount,4" frugal:"4,default,i64" json:"recommendationCount"`
}
...
func (p *UserStats) GetQuestionCount() (v int64) {
	return p.QuestionCount
}

func (p *UserStats) GetAnswerCount() (v int64) {
	return p.AnswerCount
}

func (p *UserStats) GetRecommendationCount() (v int64) {
	return p.RecommendationCount
}
func (p *UserStats) SetUserId(val int64) {
	p.UserId = val
}
func (p *UserStats) SetQuestionCount(val int64) {
	p.QuestionCount = val
}
func (p *UserStats) SetAnswerCount(val int64) {
	p.AnswerCount = val
}
func (p *UserStats) SetRecommendationCount(val int64) {
	p.RecommendationCount = val
}
