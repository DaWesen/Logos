...
const (
	...
	ChatService_GetConversationList_FullMethodName     = "/messaging.chat.ChatService/GetConversationList"
	ChatService_GetUnreadCount_FullMethodName          = "/messaging.chat.ChatService/GetUnreadCount"
	ChatService_ForwardMessage_FullMethodName          = "/messaging.chat.ChatService/ForwardMessage"
	ChatService_DeleteChat_FullMethodName              = "/messaging.chat.ChatService/DeleteChat"
	ChatService_DeleteChatHistory_FullMethodName       = "/messaging.chat.ChatService/DeleteChatHistory"
	ChatService_UpdateGroupAvatar_FullMethodName       = "/messaging.chat.ChatService/UpdateGroupAvatar"
)
...
type ChatServiceClient interface {
	...
	// 清理聊天记录
	DeleteChatHistory(ctx context.Context, in *DeleteChatHistoryRequest, opts ...grpc.CallOption) (*DeleteChatHistoryResponse, error)
	// 更新群头像
	UpdateGroupAvatar(ctx context.Context, in *UpdateGroupAvatarRequest, opts ...grpc.CallOption) (*UpdateGroupAvatarResponse, error)
}
...
func (c *chatServiceClient) DeleteChatHistory(ctx context.Context, in *DeleteChatHistoryRequest, opts ...grpc.CallOption) (*DeleteChatHistoryResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DeleteChatHistoryResponse)
	err := c.cc.Invoke(ctx, ChatService_DeleteChatHistory_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chatServiceClient) UpdateGroupAvatar(ctx context.Context, in *UpdateGroupAvatarRequest, opts ...grpc.CallOption) (*UpdateGroupAvatarResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdateGroupAvatarResponse)
	err := c.cc.Invoke(ctx, ChatService_UpdateGroupAvatar_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ChatServiceServer interface {
	...
	// 清理聊天记录
	DeleteChatHistory(context.Context, *DeleteChatHistoryRequest) (*DeleteChatHistoryResponse, error)
	// 更新群头像
	UpdateGroupAvatar(context.Context, *UpdateGroupAvatarRequest) (*UpdateGroupAvatarResponse, error)
...
func (UnimplementedChatServiceServer) DeleteChatHistory(context.Context, *DeleteChatHistoryRequest) (*DeleteChatHistoryResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DeleteChatHistory not implemented")
}
func (UnimplementedChatServiceServer) UpdateGroupAvatar(context.Context, *UpdateGroupAvatarRequest) (*UpdateGroupAvatarResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateGroupAvatar not implemented")
}
...
func _ChatService_DeleteChatHistory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteChatHistoryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ChatServiceServer).DeleteChatHistory(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ChatService_DeleteChatHistory_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServiceServer).DeleteChatHistory(ctx, req.(*DeleteChatHistoryRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _ChatService_UpdateGroupAvatar_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateGroupAvatarRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ChatServiceServer).UpdateGroupAvatar(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ChatService_UpdateGroupAvatar_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServiceServer).UpdateGroupAvatar(ctx, req.(*UpdateGroupAvatarRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ChatService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ChatService_DeleteChatHistory_Handler,
		},
		{
			MethodName: "UpdateGroupAvatar",
			Handler:    _ChatService_UpdateGroupAvatar_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "idl/messaging/chat.proto",
}
